...
public class Missing_Date_Record extends AppCompatActivity {

    private TableLayout missing_work_TableLayout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_missing__date__record);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.i("Missing_Date_Record", responseData);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    //設置每筆資料的小TableLayout
                    TableLayout small_tb = new TableLayout(Missing_Date_Record.this);
                    //全部列自動填充空白處
                    ...
                    //設置每筆派工的派工單號、送貨客戶
                    LinearLayout dynamically_llt = new LinearLayout(Missing_Date_Record.this);
                    ...
                    TableRow tr1 = new TableRow(Missing_Date_Record.this);
                    ...
                    LinearLayout dynamically_llt2 = new LinearLayout(Missing_Date_Record.this);
