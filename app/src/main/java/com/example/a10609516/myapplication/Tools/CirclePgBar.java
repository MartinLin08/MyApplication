...
public class CirclePgBar extends View {
    ...
    private List<CirclePgBarBean> circlePgBarBeanList;
    View.OnClickListener click_handler;
    ...
    public void setmCirclePgBar(float mProgress, float mTargetProgress, int mMax, int mColor) {
        CirclePgBarBean circlePgBarBean = new CirclePgBarBean();
        circlePgBarBean.setmProgress(mProgress);
        this.mProgress = mProgress;
        circlePgBarBean.setmTargetProgress(mTargetProgress);
        this.mTargetProgress = mTargetProgress;
        circlePgBarBean.setmMax(mMax);
        this.mMax = mMax;
        circlePgBarBean.setmColor(mColor);
        this.mColor = mColor;
        circlePgBarBeanList = new ArrayList<>();
        circlePgBarBeanList.add(circlePgBarBean);
        mFrontPaint.setColor(mColor);
        mTextPaint.setColor(mColor);
    }
}
