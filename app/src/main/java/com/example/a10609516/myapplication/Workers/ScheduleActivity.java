    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.points_item:
                ...
                break; //進入查詢工務點數頁面
            case R.id.miss_item:
                Intent intent14 = new Intent(ScheduleActivity.this, MissCountActivity.class);
    ...
    private Runnable TimerRunnable = new Runnable() {
        ...
        public void run() {
            if (isAutoPlay) {
                ...
                // 如果處於拖曳狀態則停止播放，會每隔5秒檢查一次是否可以正常自動播放。
            ...
            public void onPageScrollStateChanged(int state) {
                switch (state) {
                    ...
                    /*case ViewPager.SCROLL_STATE_IDLE:
                        ...
                        } else if (viewPager.getCurrentItem() == count + 2) {
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            ...
                            .url("http://192.168.0.172/WQP/WeekScheduleData.php")
                            .post(requestBody)
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData = response.body().string();
