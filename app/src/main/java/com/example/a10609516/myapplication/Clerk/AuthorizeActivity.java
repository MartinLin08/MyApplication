package com.example.a10609516.myapplication.Clerk;
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            ...
                            .url("http://192.168.0.172/WQP/QuotationRead.php")
                            .post(requestBody)
                            .build();
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            ...
                            .url("http://192.168.0.172/WQP/QuotationMaster.php")
                            .post(requestBody)
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData = response.body().string();
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            ...
                            .url("http://192.168.0.172/WQP/QuotationApproved.php")
                            .post(requestBody)
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData = response.body().string();
            ...
            public void run() {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            ...
                            .url("http://192.168.0.172/WQP/QuotationReject.php")
                            .post(requestBody)
                            .build();
                    Response response = client.newCall(request).execute();
                    String responseData = response.body().string();
